...
<section class="py-5">
  <div class="container">
    <div style="margin-bottom: 10px;" class="col-12">
      <a style=" font-size: 18px;" href="{{ route('eventmanager.home') }}"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="white" class="bi bi-arrow-left-square-fill" viewBox="0 0 16 16">
