                      ...
                      <div class="bg-white shadow rounded overflow-hidden">
                          <div class="px-4 pt-0 pb-4 cover">
                              <div class="media align-items-end profile-head">
                                  <div class="profile mr-3"><img src="{{ asset('uploads/profile/'.$user->image) }}"  alt="" width="160" style="height: 160px;" class="shadow rounded mb-2 img-thumbnail"></div>
                                  <div class="media-body mb-5 text-white">

                                      <input style="width: 175px; font-size: 16px;
                                      color: white;" type="text" name="name" class=" mt-0 mb-0" value="{{ $user->name}}">
                                      ...
                                      color: white; " type="text" name="location"  value="{{ $user->location}}"></p>
                                  </div>
